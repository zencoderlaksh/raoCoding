...
export type EntitlementIntegrationType = 'discord' | 'telegram' | 'github' | 'figma' | 'framer' | 'notion' | 'digital_files' | 'license_key' | 'feature_flag';
/**
 ...
 * `feature_flag` config.
 */
export type IntegrationConfig = IntegrationConfig.FeatureFlagConfig | IntegrationConfig.GitHubConfig | IntegrationConfig.DiscordConfig | IntegrationConfig.TelegramConfig | IntegrationConfig.FigmaConfig | IntegrationConfig.FramerConfig | IntegrationConfig.NotionConfig | IntegrationConfig.DigitalFilesConfig | IntegrationConfig.LicenseKeyConfig;
 ...
 */
export type IntegrationConfigResponse = IntegrationConfigResponse.FeatureFlagConfig | IntegrationConfigResponse.GitHubConfig | IntegrationConfigResponse.DiscordConfig | IntegrationConfigResponse.TelegramConfig | IntegrationConfigResponse.FigmaConfig | IntegrationConfigResponse.FramerConfig | IntegrationConfigResponse.NotionConfig | IntegrationConfigResponse.DigitalFilesConfig | IntegrationConfigResponse.LicenseKeyConfig;
...
export interface EntitlementListParams extends DefaultPageNumberPaginationParams {
     ...
     */
    integration_type?: 'discord' | 'telegram' | 'github' | 'figma' | 'framer' | 'notion' | 'digital_files' | 'license_key' | 'feature_flag';
}
