...
import * as GrantsAPI from "../entitlements/grants.js";
import { EntitlementGrantsDefaultPageNumberPagination } from "../entitlements/grants.js";
...
export declare class Customers extends APIResource {
     ...
     * ```
     */
    listEntitlementGrants(customerID: string, query?: CustomerListEntitlementGrantsParams | null | undefined, options?: RequestOptions): PagePromise<EntitlementGrantsDefaultPageNumberPagination, GrantsAPI.EntitlementGrant>;
}
