...
import * as MetersAPI from "./meters.mjs";
...
export declare namespace FilterType {
    interface MeterFilterConditionList {
        /**
         * Filter key to apply
         */
        key: string;
...
export declare namespace Meters {
    export { type Conjunction as Conjunction, type FilterOperator as FilterOperator, type FilterType as FilterType, type Meter as Meter, type MeterAggregation as MeterAggregation, type MeterFilter as MeterFilter, type MetersDefaultPageNumberPagination as MetersDefaultPageNumberPagination, type MeterListParams as MeterListParams, type MeterCreateParams as MeterCreateParams, };
}
