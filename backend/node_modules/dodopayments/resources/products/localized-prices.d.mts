...
export declare class LocalizedPrices extends APIResource {
    /**
     * @example
     * ```ts
     ...
     * ```
     */
    create(productID: string, body: LocalizedPriceCreateParams, options?: RequestOptions): APIPromise<LocalizedPrice>;
    /**
     * @example
     * ```ts
     * const localizedPrice =
     ...
     * ```
     */
    retrieve(id: string, params: LocalizedPriceRetrieveParams, options?: RequestOptions): APIPromise<LocalizedPrice>;
    /**
     * @example
     * ```ts
     * const localizedPrice =
     ...
     * ```
     */
    update(id: string, params: LocalizedPriceUpdateParams, options?: RequestOptions): APIPromise<LocalizedPrice>;
    /**
     * @example
     * ```ts
...
export declare namespace LocalizedPrices {
    export { type ListLocalizedPricesResponse as ListLocalizedPricesResponse, type LocalizedPrice as LocalizedPrice, type PricingMode as PricingMode, type LocalizedPriceCreateParams as LocalizedPriceCreateParams, type LocalizedPriceRetrieveParams as LocalizedPriceRetrieveParams, type LocalizedPriceUpdateParams as LocalizedPriceUpdateParams, type LocalizedPriceArchiveParams as LocalizedPriceArchiveParams, };
}
//# sourceMappingURL=localized-prices.d.mts.map