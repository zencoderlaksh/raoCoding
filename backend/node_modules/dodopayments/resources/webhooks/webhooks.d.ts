...
import { CursorPagePagination, type CursorPagePaginationParams, PagePromise } from "../../core/pagination.js";
...
export declare namespace AbandonedCheckoutDetectedWebhookEvent {
    /**
     * Webhook payload for abandoned_checkout.detected and abandoned_checkout.recovered
     * events
     */
...
export declare namespace AbandonedCheckoutRecoveredWebhookEvent {
    /**
     * Webhook payload for abandoned_checkout.detected and abandoned_checkout.recovered
     * events
     */
...
export declare namespace CreditBalanceLowWebhookEvent {
    /**
     * Webhook payload for credit.balance_low event
     */
    interface Data {
...
export declare namespace DunningRecoveredWebhookEvent {
    /**
     * Webhook payload for dunning.started and dunning.recovered events
     */
    interface Data {
...
export declare namespace DunningStartedWebhookEvent {
    /**
     * Webhook payload for dunning.started and dunning.recovered events
     */
    interface Data {
