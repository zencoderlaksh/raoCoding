...
export interface BalanceLedgerEntry {
    ...
    event_type: 'payment' | 'refund' | 'refund_reversal' | 'dispute' | 'dispute_reversal' | 'tax' | 'tax_reversal' | 'payment_fees' | 'refund_fees' | 'refund_fees_reversal' | 'dispute_fees' | 'payout' | 'payout_fees' | 'payout_reversal' | 'payout_fees_reversal' | 'dodo_credits' | 'adjustment' | 'currency_conversion' | 'abandoned_cart_recovery_fee' | 'dunning_fees' | 'payment_retry_fee' | 'byop_fee';
    is_credit: boolean;
...
export declare namespace Balances {
    export { type BalanceLedgerEntry as BalanceLedgerEntry, type BalanceLedgerEntriesDefaultPageNumberPagination as BalanceLedgerEntriesDefaultPageNumberPagination, type BalanceRetrieveLedgerParams as BalanceRetrieveLedgerParams, };
}
