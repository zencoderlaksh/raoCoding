...
class Subscriptions extends resource_1.APIResource {
    ...
    updatePaymentMethod(subscriptionID, params, options) {
        ...
        return this._client.post((0, path_1.path) `/subscriptions/${subscriptionID}/update-payment-method`, {
            body: payment_method,
            ...options,
        });
    }
    ...
    previewChangePlan(subscriptionID, body, options) {
        return this._client.post((0, path_1.path) `/subscriptions/${subscriptionID}/change-plan/preview`, {
            body,
            ...options,
        });
    }
    ...
    retrieveCreditUsage(subscriptionID, options) {
        return this._client.get((0, path_1.path) `/subscriptions/${subscriptionID}/credit-usage`, options);
    }
    /**
     * @example
     * ```ts
    ...
    cancelChangePlan(subscriptionID, options) {
        return this._client.delete((0, path_1.path) `/subscriptions/${subscriptionID}/change-plan/scheduled`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
