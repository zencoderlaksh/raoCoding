...
import { ItemCreateParams, ItemCreateResponse, ItemDeleteParams, ItemUpdateParams, Items, ProductCollectionProduct } from "./items.js";
...
export declare class Groups extends APIResource {
     ...
     * ```
     */
    create(id: string, body: GroupCreateParams, options?: RequestOptions): APIPromise<ProductCollectionGroupResponse>;
    /**
     * @example
     * ```ts
...
export declare namespace Groups {
    export { type GroupProduct as GroupProduct, type ProductCollectionGroupDetails as ProductCollectionGroupDetails, type ProductCollectionGroupResponse as ProductCollectionGroupResponse, type GroupCreateParams as GroupCreateParams, type GroupDeleteParams as GroupDeleteParams, type GroupUpdateParams as GroupUpdateParams, };
    export { Items as Items, type ProductCollectionProduct as ProductCollectionProduct, type ItemCreateResponse as ItemCreateResponse, type ItemCreateParams as ItemCreateParams, type ItemDeleteParams as ItemDeleteParams, type ItemUpdateParams as ItemUpdateParams, };
}
