...
exports.CreditEntitlements = void 0;
...
class CreditEntitlements extends resource_1.APIResource {
    constructor() {
        super(...arguments);
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/credit-entitlements', (pagination_1.DefaultPageNumberPagination), {
            query,
            ...options,
        });
    }
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/credit-entitlements/${id}`, options);
    }
    /**
     * @example
     * ```ts
     ...
     */
    delete(id, options) {
        return this._client.delete((0, path_1.path) `/credit-entitlements/${id}`, {
            ...options,
    ...
    update(id, body, options) {
        return this._client.patch((0, path_1.path) `/credit-entitlements/${id}`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
     ...
     */
    undelete(id, options) {
        return this._client.post((0, path_1.path) `/credit-entitlements/${id}/undelete`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
        });
    }
}
exports.CreditEntitlements = CreditEntitlements;
CreditEntitlements.Balances = balances_1.Balances;
//# sourceMappingURL=credit-entitlements.js.map