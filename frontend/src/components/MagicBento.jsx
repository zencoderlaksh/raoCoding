...
const DEFAULT_GLOW_COLOR = '255, 180, 120';
const MOBILE_BREAKPOINT = 768;
const images = [
  computer,two,three,four,five,six
];
const cardData = [
  {
    color: 'rgba(10, 10, 10, 0.55)',
    title: "Coding Community",
    description:"Learning, building, and scaling together",
    label: (
  ...
  },
  {
    color: 'rgba(10, 10, 10, 0.55)',
    title: 'Global Reach',
    description: 'Helping clients scale with confidence',
    label: (
      <div className="flex items-center gap-2 text-amber-300">
        <Star size={16} fill='orange'/>
  ...
  },
  {
    ...
    label: (
      <div className="flex items-center gap-2 text-amber-300 text-2xl">
        <Rocket fill='orange'/>
  ...
  
  {
    ...
    label: (
      <div className="flex items-center gap-2 text-amber-300">
        <GraduationCap size={16} fill='orange'/>
  ...
  },
  {
    color: 'rgba(10, 10, 10, 0.55)',
    title: 'Real Projects',
    description: 'Build practical skills through experience',
    label: (
      <div className="flex items-center gap-2 text-amber-300">
        <FolderKanban size={16} fill='orange'/>
        <span>Projects</span>
      </div>
    )
  }
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --orange-primary: rgba(255, 140, 60, 1);
            --orange-glow: rgba(255, 140, 60, 0.2);
            --orange-border: rgba(255, 140, 60, 0.8);
          }
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(255, 140, 60, 0.18),
            0 0 35px rgba(${glowColor}, 0.15);
          }
          ...
          .particle::before {
            ...
            .particle-container:hover {
              box-shadow: 0 4px 20px rgba(255, 140, 60, 0.2),
